...
export function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      >
        <nav
          className="relative z-10 flex items-center justify-between px-8 lg:px-16 py-5 border-b border-white/[0.06]"
          role="navigation"
      ...
      <section className="relative z-10 flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-24 px-8 lg:px-16 py-20 max-w-7xl mx-auto w-full">
        <div className="flex-1 space-y-8 text-center lg:text-left max-w-xl glass-card p-8">
          ...
          <MotionDiv y={20} opacity={0} delay={1.1}>
          ...
          <MotionDiv y={20} opacity={0} delay={1.5}>
      ...
      {/* Footer */}
      <MotionDiv y={20} opacity={0} once={false}>
