...
function StatCardSkeleton() {
  return (
    <div className="glass-panel p-6 border border-slate-800 rounded-xl shadow-lg">
      ...
      <div className="h-6 w-24 rounded bg-gradient-to-r from-slate-700 via-slate-600 to-slate-700 bg-[length:200%_100%] animate-shimmer" />
      <div className="h-3 w-16 rounded mt-1 bg-gradient-to-r from-slate-700 via-slate-600 to-slate-700 bg-[length:200%_100%] animate-shimmer" />
    </div>
  )
}
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <div className="h-8 w-48 rounded mb-1 bg-gradient-to-r from-slate-700 via-slate-600 to-slate-700 bg-[length:200%_100%] animate-shimmer" />
          <div className="h-4 w-64 rounded bg-gradient-to-r from-slate-700 via-slate-600 to-slate-700 bg-[length:200%_100%] animate-shimmer" />
        </div>
        <div className="h-10 w-36 rounded-xl bg-gradient-to-r from-crystal-600/50 via-crystal-500/50 to-crystal-600/50 bg-[length:200%_100%] animate-shimmer" />
      </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          <div className="h-4 w-32 rounded bg-gradient-to-r from-slate-700 via-slate-600 to-slate-700 bg-[length:200%_100%] animate-shimmer" />
          <div className="h-4 w-20 rounded bg-gradient-to-r from-slate-700 via-slate-600 to-slate-700 bg-[length:200%_100%] animate-shimmer" />
        </div>
